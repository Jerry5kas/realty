...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-lg border-2 overflow-hidden" style="border-color: {{ $theme['primary_color'] }};">
        <div class="px-6 py-4 border-b" style="background-color: {{ $theme['primary_color'] }}; border-color: {{ $theme['secondary_color'] }}; color: white;">
            <h2 class="text-xl font-semibold text-white">Edit Banner</h2>
        </div>

        <form action="{{ route('banners.update', $banner) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <x-imagekit-uploader
                        ...
                        :multiple="false"
                        :existingImages="$banner->image_url ? [$banner->image_url] : []"
                        folder="/banners"
                    />
                ...
                <div>
                    ...
                    <x-imagekit-uploader
                        ...
                        :multiple="false"
                        :existingImages="$banner->mobile_image_url ? [$banner->mobile_image_url] : []"
                        folder="/banners/mobile"
                    />
                    <p class="mt-1 text-sm text-gray-500">Recommended size: 768x400px for mobile devices. If not provided, desktop image will be used.</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <x-form-select
                        label="Section"
                        name="section"
                        :value="old('section', $banner->section)"
                        required
                        :options="[
                            'hero' => 'Hero',
                            'sidebar' => 'Sidebar',

        ...
        <div class="flex-1 p-5 flex flex-col justify-between">
            ...
            <div>
                ...
                <div class="flex items-start justify-between gap-2 mb-2">
                    <a href="{{ route('property.show', $property->slug) }}" class="text-lg font-bold line-clamp-1 hover:text-blue-600 transition-colors cursor-pointer flex-1" style="color: {{ $theme['primary_color'] }};">
                        {{ $property->title }}
                    </a>
                    @if($property->type)
            ...
            <div>
                ...
                <div class="flex items-center gap-2">
                    <a href="{{ route('property.show', $property->slug) }}" 
                       ...
                       style="border-color: {{ $theme['primary_color'] }}; color: {{ $theme['primary_color'] }};">
                    ...
                    <a href="tel:+971501234567" 
                       class="w-12 h-12 rounded-lg font-semibold text-sm text-center bg-gray-100 hover:bg-gray-200 transition-all flex items-center justify-center transform hover:-translate-y-0.5"

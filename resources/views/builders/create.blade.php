...
@section('page-title', 'Add Builder')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-lg border-2 overflow-hidden" style="border-color: {{ $theme['primary_color'] }};">
        <div class="px-6 py-4 border-b" style="background-color: {{ $theme['primary_color'] }}; border-color: {{ $theme['secondary_color'] }};">
            <h2 class="text-xl font-semibold text-white">Builder Information</h2>
        </div>

        <form action="{{ route('builders.store') }}" method="POST" class="p-6">
            @csrf
                ...
                <x-tab-content id="business">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <x-form-input
                            ...
                            :value="old('rera_registration_number')"
                        ...
                        <x-form-input
                            ...
                            type="number"
                            :value="old('total_projects_completed', 0)"
                            min="0"
                            placeholder="e.g., 25"
                        />
                        ...
                        <div>
                            ...
                            <div class="flex gap-4">
                                <label class="flex items-center">
                                    <input type="radio" name="status" value="active" {{ old('status', 'active') === 'active' ? 'checked' : '' }} class="mr-2" style="color: {{ $theme['secondary_color'] }};">
                                    <span>Active</span>
                                </label>
                                <label class="flex items-center">
                                    <input type="radio" name="status" value="inactive" {{ old('status') === 'inactive' ? 'checked' : '' }} class="mr-2" style="color: {{ $theme['secondary_color'] }};">
                                    <span>Inactive</span>
                                </label>
                            </div>
                            @error('status')
